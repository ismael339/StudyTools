...
async function main() {
  try {
    ...
    const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>📚 Study Tips Semanales</title><style>body{font-family:'Segoe UI',Arial,sans-serif;line-height:1.6;color:#333;max-width:600px;margin:0 auto;padding:20px;background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%)}.container{background:#fff;border-radius:20px;padding:40px;box-shadow:0 20px 60px rgba(0,0,0,.2)}.header{background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%);color:#fff;padding:30px;border-radius:15px;text-align:center;margin-bottom:30px;position:relative;overflow:hidden}.header::before{content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle,rgba(255,255,255,.1) 0%,transparent 70%);animation:shine 3s infinite}@keyframes shine{0%,100%{transform:translate(-30%,-30%)}50%{transform:translate(30%,30%)}}.header h1{margin:0;font-size:26px;font-weight:700;text-shadow:2px 2px 4px rgba(0,0,0,.2)}.emoji{font-size:45px;margin-bottom:10px;display:block}.week-badge{background:#4CAF50;color:#fff;padding:8px 20px;border-radius:20px;font-size:14px;font-weight:bold;display:inline-block;margin:15px 0}.content{padding:20px 0}.intro-text{font-size:18px;color:#555;margin-bottom:25px;text-align:center}.tip-box{background:linear-gradient(135deg,#ffecd2 0%,#fcb69f 100%);border-radius:15px;padding:25px;margin:20px 0;border-left:5px solid #f5576c}.tip-box h3{margin-top:0;color:#f5576c;font-size:18px;margin-bottom:15px}.tip-number{font-size:24px;font-weight:bold;color:#f5576c;margin-right:10px}.tools-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:15px;margin:25px 0}.tool-card{background:#f8f9fa;border-radius:12px;padding:20px;text-align:center;transition:transform .3s}.tool-card:hover{transform:translateY(-5px)}.tool-emoji{font-size:30px;margin-bottom:10px;display:block}.tool-name{font-weight:bold;color:#333;font-size:14px}.tool-link{color:#f5576c;text-decoration:none;font-size:12px;margin-top:5px;display:block}.cta{background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%);color:#fff;padding:15px 40px;text-decoration:none;border-radius:25px;display:inline-block;margin:25px 0;font-weight:bold;font-size:16px;box-shadow:0 10px 20px rgba(240,147,251,.3);transition:transform .3s}.cta:hover{transform:translateY(-3px)}.motivation{background:linear-gradient(135deg,#a8edea 0%,#fed6e3 100%);border-radius:15px;padding:25px;margin:25px 0;text-align:center}.motivation-text{font-size:16px;color:#444;font-style:italic;margin:0}.footer{margin-top:40px;padding-top:25px;border-top:2px solid #eee;color:#777;font-size:13px;text-align:center}.date-text{color:#999;font-size:12px;margin-top:10px}</style></head><body><div class="container"><div class="header"><span class="emoji">📚</span><h1>¡TUS STUDY TIPS DE LA SEMANA!</h1><div class="week-badge">SEMANA ${weekNumber} - ${month.toUpperCase()}</div></div><div class="content"><p class="intro-text">¡Hola estudiante! 👋<br>¡Es lunes de <strong>${month}</strong>! Ya sabes lo que significa: nuevas oportunidades para aprender y crecer.</p><div class="tip-box"><h3><span class="tip-number">💡</span> TIP #1: La Regla de los 5 Minutos</h3><p style="font-size:15px;color:#444;margin:0">¿Te cuesta empezar a estudiar? Comprométete a estudiar solo 5 minutos. Casi siempre, una vez que empiezas, seguirás más tiempo. El truco es vencer la resistencia inicial.</p></div><div class="tip-box"><h3><span class="tip-number">🎯</span> TIP #2: Tu Reto de Esta Semana</h3><p style="font-size:15px;color:#444;margin:0">Elige una materia donde estás luchando y dedícale 20 minutos cada día esta semana. Pequeños pasos consistentes logran grandes resultados.</p></div><div class="tip-box"><h3><span class="tip-number">⚡</span> TIP #3: Técnica Pomodoro</h3><p style="font-size:15px;color:#444;margin:0">Estudia en bloques de 25 minutos con descansos de 5 minutos. Tu cerebro necesita descansos para procesar información efectivamente.</p></div><p style="text-align:center;font-size:16px;font-weight:bold;color:#333;margin:25px 0">🛠️ HERRAMIENTAS QUE TE AYUDARÁN ESTA SEMANA:</p><div class="tools-grid"><div class="tool-card"><span class="tool-emoji">🧠</span><div class="tool-name">AI Tutor</div><a href="https://www.studytools.pro/study-assistant.html" class="tool-link">Pregunta dudas →</a></div><div class="tool-card"><span class="tool-emoji">📊</span><div class="tool-name">GPA Calculator</div><a href="https://www.studytools.pro/gpa-calculator.html" class="tool-link">Calcula promedio →</a></div><div class="tool-card"><span class="tool-emoji">⏰</span><div class="tool-name">Pomodoro Timer</div><a href="https://www.studytools.pro/pomodoro-timer.html" class="tool-link">Estudia mejor →</a></div></div><div class="motivation"><p class="motivation-text">"El éxito no es la clave de la felicidad. La felicidad es la clave del éxito. Si amas lo que haces, tendrás éxito." - Albert Schweitzer</p></div><p style="text-align:center;font-size:16px;margin:25px 0"><a href="https://www.studytools.pro" class="cta">¡EMPEZAR A ESTUDIAR! →</a></p><p style="text-align:center;font-size:14px;color:#666">¡Tienes una semana completa por delante para lograr tus objetivos académicos! 🎓</p></div><div class="footer"><p>© 2026 StudyTools.pro - Herramientas de estudio gratuitas para estudiantes</p><p><a href="https://www.studytools.pro/privacy.html" style="color:#f5576c;text-decoration:none">Política de privacidad</a> | <a href="https://www.studytools.pro" style="color:#f5576c;text-decoration:none">Sitio web</a></p><p class="date-text">Fecha: ${date}</p></div></div></body></html>`;

    let successCount = 0;
    for (const email of emails) {
      try {
        await sendEmail(email, `📚 ¡TUS STUDY TIPS DE LA SEMANA! - Semana ${weekNumber}`, html);
        successCount++;
